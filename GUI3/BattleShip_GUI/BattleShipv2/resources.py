...
class Map:
    ...
    def __init__(self, size: int, graphic_board: dict[tuple[int, int], 'SquareWidget']) -> None:
        self.size = size
        self.squares = {}
    ...
    def _add_square(self) -> None:
        ...
        if self.graphic_board:
            new_square.widget = self.graphic_board[(self.column_count, self.row_count)]
            new_square.widget.square = new_square
